...
public class PurchaseController {
	...
	public String addPurchase( @ModelAttribute("purchase") Purchase purchase ,
		...
		purchase.setDivyAddr(addr1, addr2, addr3);
		
		System.out.println("12222222222222222222222222222222222222222222222222222222"+addr1);
...
//		model.addAttribute("Buyer",request.getSession(true).getAttribute("user"));
	...
	//	System.out.println("야야야야야야야야야야야야야야야야" + divyDate);
