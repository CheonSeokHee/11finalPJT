...
<head>
	...
	<script type="text/javascript">
		...
		$( function() {
			//==> 추가된부분 : "addUser"  Event 연결
			$("a[href='#ex1' ]:contains('로 그 인')").on("click" , function() {
		...
		$( function() {
			//==> 추가된부분 : "addUser"  Event 연결
			$("a[href='#ex2' ]:contains('상품검색')").on("click" , function() {
...
<body>
	...
	<div class="navbar  navbar-default">
        ...
        <div class="container">
        	...
        	<a class="navbar-brand" href="#">몽돌샵</a>
...
<!-- 						 <li class="list-group-item"> -->
<!-- 						 	<a href="#">회원탈퇴</a> <i class="glyphicon glyphicon-ban-circle"></i>						 	 -->
<!-- 						 </li>	 -->
...
<!-- 		        </div> -->
				...
				<div class="panel panel-primary">
					...
					<ul class="list-group">
						 <li class="list-group-item"><a href="#ex2" id="search">상품검색</a></li>
<!-- 						  <li class="list-group-item"> -->
			...
			<!--  Menu 구성 end /////////////////////////////////////-->   
	 	 	...
	 	 	<div class="col-md-9">
				<div class="jumbotron">
			  		...
			  		<p><a class="btn btn-info btn-lg" href="#ex1" rel="modal:open" role="button">로그인</a></p>
			  		</div>
