...
// 				 alert("userId: " + userId);
		 ...
		 $("button.btn.btn-num").on("click" , function() {
...
// 				async: false,
		...
		//$("form").attr("method" , "GET").attr("action" , "/user/sendSMS").submit();	
	...
	<div class="container">
		...
		<form class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="userId" name="userId"  data-userId = "${user.userId}" placeholder="중복확인하세요"  readonly required>
...
<!-- 					       경고 화면 들어갈 공간을 만들어줌 -->
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="phone" name="phoneCheck" placeholder="인증번호를 입력하세요" >
		    </div>
		    
		      <button type="button" class="btn btn-num">인증번호 받기</button>
		       <input type="button" class="btn btn-check" value="확인" onclick="btn_on();" >
...
<!-- 		      <button type="button" class="btn btn-check">확인</button> -->
		  ...
		  <div class="form-group">
		    ...
		    <input type="button" class="btn btn-primary" id="btn" value="가입" disabled="disabled">
<!-- 		    <input type="button" class="btn btn-primary" value="가입" onclick='btnActive()'> -->	    
<!-- 		      <input type="button" class="btn btn-primary" >가 &nbsp;입</input>	       -->
