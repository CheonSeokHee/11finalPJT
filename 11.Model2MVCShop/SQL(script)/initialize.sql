...
CREATE TABLE transaction ( 
	...
	buyer_id 				VARCHAR2(20)	NOT NULL REFERENCES users(user_id) ON DELETE CASCADE,
...
insert into product values (seq_product_prod_no.nextval,'애견패드 소형 50매','친환경 소재를 이용한 애견패드','20120514',2000000, '5555.jpg',to_date('2012/12/14 11:27:27', 'YYYY/MM/DD HH24:MI:SS'));
insert into product values (seq_product_prod_no.nextval,'구루머스 치킨 우유껌 7개입','몽돌샵 판매 1위 제품','20120514',10000, '6666.jpg',to_date('2012/11/14 10:48:43', 'YYYY/MM/DD HH24:MI:SS'));
insert into product values (seq_product_prod_no.nextval,'페페로니 오메가3 소고기','뼈에 좋은 오메가3 소고기','20120201',1170000, '1212.jpg',to_date('2012/10/14 10:49:39', 'YYYY/MM/DD HH24:MI:SS'));
insert into product values (seq_product_prod_no.nextval,'도모다찌 고구마 사시미','반려견들에 위에 좋은 고구마를 사용한 사시미 포','20120217', 200000, '44444.jpg',to_date('2012/11/14 10:50:58', 'YYYY/MM/DD HH24:MI:SS'));
insert into product values (seq_product_prod_no.nextval,'카리에스 덴탈껌 6개입','치석 제거에 좋은 덴마크 덴탈껌','20120819', 20000, '9999.jpg',to_date('2012/11/14 10:51:40', 'YYYY/MM/DD HH24:MI:SS'));
insert into product values (seq_product_prod_no.nextval,'네튜럴코어 홀리스틱 베네 M32 멀티프로테스인','반려견 시력 증진을 위한 멀티프로스테인','20121121',800000, '33333.jpg',to_date('2012/11/14 18:46:58', 'YYYY/MM/DD HH24:MI:SS'));
insert into product values (seq_product_prod_no.nextval,'네튜럴코어 시니어 오리 고구마','오리와 고구마를 이용한 네튜럴코어 간식','20121022',232300, '2233.jpg',to_date('2012/11/15 17:39:01', 'YYYY/MM/DD HH24:MI:SS'));
insert into product values (seq_product_prod_no.nextval,'네튜럴코어 퍼피 작은 알갱이','소형견을 위한 친환경 간식 ','20120212',600000, '8888.jpg',to_date('2012/11/12 13:04:31', 'YYYY/MM/DD HH24:MI:SS'));
